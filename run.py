...
class Hangman:
    ...
    def __init__(self, word_list):
        ...
        Parameters:
        word_list (list): A list of strings representing th possible words
        in the game.

        Attributes:
        word(str): The word to be guessed by the player.
        guesses (list): A list of letters that the player has guessed so far.
        num_guesses (int): The number of incorrect guesses allowed before the
        game is over.
        current_guesses (int): The number of incorrect guesses made by the
        player so far.
        display_word (str): The word as it appears to the player, with
        underscores representing unguessed letters.
        hangman_states (list): A list of art representations of the hangman as
        it is being drawn.
        """
    ...
    def intro(self):
        ...
        print("Quick Hint: think about fruits.")
        print("Good Luck!!")
        print("\n")

    def word_choose(self):
        """
        Chooses a word at random from the list of possible words and
        initializes the display_word attribute.
        """
    ...
    def play(self):
        """
        Plays a game of Hangman. Calls the intro, word_choose, and guess
        methods untill the game is won or lost.
        ...
        while True:
            ...
            while True:
                ...
                if self.guesses_current == self.guesses_num:
                    ...
                    break
            print("\n")
            play_again = input("Do you want to give your self another try?"
                               "(y/n):")
